...
int main(){
    ...
    if (produto >= 1 && produto <= 10){
        valor = 10 * quantidade;
        printf("Produtos 1 a 10 Valor de: R$ 10,00\n");
    } else if (produto >= 11 && produto <= 20){
        valor = 15 * quantidade;
        printf("Produtos 11 a 20 Valor de: R$ 15,00\n");
    } else if (produto >= 21 && produto <= 30){
        valor = 20 * quantidade;
        printf("Produtos 21 a 30 Valor de: R$ 20,00\n");
    } else if (produto >= 31 && produto <= 40){
        valor = 30 * quantidade;
        printf("Produtos 31 a 40 Valor de: R$ 30,00\n");
    }
